1. **Я, как аналитик компании, должен буду в данном проекте провести предварительный анализ тарифов на выборке клиентов. Нужно проанализировать поведение клиентов и сделать вывод — какой тариф лучше.**
----------------------------------------
2. **ОПИСАНИЕ ДАННЫХ:** 
